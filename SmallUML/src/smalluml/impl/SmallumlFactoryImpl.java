...
public class SmallumlFactoryImpl extends EFactoryImpl implements SmallumlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SmallumlPackage.SMALL_BOOLEAN: return createsmallBoolean();
			case SmallumlPackage.SMALL_INTEGER: return createsmallInteger();
			case SmallumlPackage.SMALL_REAL: return createsmallReal();
			case SmallumlPackage.SMALL_STRING: return createsmallString();
	 ...
	 * @generated
	 */
	public smallBoolean createsmallBoolean() {
		smallBooleanImpl smallBoolean = new smallBooleanImpl();
		return smallBoolean;
	}
	 ...
	 * @generated
	 */
	public smallReal createsmallReal() {
		smallRealImpl smallReal = new smallRealImpl();
		return smallReal;
	}
	 ...
	 * @generated
	 */
	public smallString createsmallString() {
		smallStringImpl smallString = new smallStringImpl();
		return smallString;
	}
