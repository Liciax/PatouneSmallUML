 ...
 *   <li>{@link smalluml.impl.AssociationImpl#getRoles <em>Roles</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationImpl extends AbstractEntityImpl implements Association {
	/**
	...
	public EList<Role> getRoles() {
		if (roles == null) {
			roles = new EObjectContainmentEList<Role>(Role.class, this, SmallumlPackage.ASSOCIATION__ROLES);
		}
		return roles;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SmallumlPackage.ASSOCIATION__ROLES:
