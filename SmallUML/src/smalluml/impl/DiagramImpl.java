 ...
 * </p>
 * <ul>
 *   <li>{@link smalluml.impl.DiagramImpl#getName <em>Name</em>}</li>
...
public class DiagramImpl extends MinimalEObjectImpl.Container implements Diagram {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmallumlPackage.DIAGRAM__NAME, oldName, name));
	}
	...
	public EList<AbstractEntity> getEntities() {
		if (entities == null) {
			entities = new EObjectContainmentEList<AbstractEntity>(AbstractEntity.class, this, SmallumlPackage.DIAGRAM__ENTITIES);
		}
		return entities;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmallumlPackage.DIAGRAM__NAME:
				return getName();
			case SmallumlPackage.DIAGRAM__ENTITIES:
				return getEntities();
		}
